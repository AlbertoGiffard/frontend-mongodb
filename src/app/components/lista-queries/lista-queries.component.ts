...
export class ListaQueriesComponent implements OnInit {
  //http://localhost:4000
  obtenerTickets = 'https://backend-mongodb-tp.herokuapp.com/';
  desperfectosPorTitulo = 'https://backend-mongodb-tp.herokuapp.com/desperfectosPorTitulo';
  desperfectosEnOctubre = 'https://backend-mongodb-tp.herokuapp.com/desperfectosEnOctubre';
  desperfectosPorOficina = 'https://backend-mongodb-tp.herokuapp.com/desperfectosPorOficina';
  aiendeMasTickets = 'https://backend-mongodb-tp.herokuapp.com/aiendeMasTickets';
  sinResolver = 'https://backend-mongodb-tp.herokuapp.com/sinResolver';
  clientesCercaDeOficinas = 'https://backend-mongodb-tp.herokuapp.com/clientesCercaDeOficinas';
  clientesEnBA = 'https://backend-mongodb-tp.herokuapp.com/clientesEnBA';
  cantidadPlanNormalOSuperPack = 'https://backend-mongodb-tp.herokuapp.com/cantidadPlanNormalOSuperPack';
  promedioPrecioPlan = 'https://backend-mongodb-tp.herokuapp.com/promedioPrecioPlan';
  incrementoPlanNormal = 'https://backend-mongodb-tp.herokuapp.com/incrementoPlanNormal';
  incrementoPlanSuperPack = 'https://backend-mongodb-tp.herokuapp.com/incrementoPlanSuperPack';
  maxPlanNormal = 'https://backend-mongodb-tp.herokuapp.com/maxPlanNormal';
  minPlanSuperPack = 'https://backend-mongodb-tp.herokuapp.com/minPlanSuperPack';
  agregarCampoVip = 'https://backend-mongodb-tp.herokuapp.com/agregarCampoVip';
  renombrarCampoVip = 'https://backend-mongodb-tp.herokuapp.com/renombrarCampoVip';
  borrarCampoVip = 'https://backend-mongodb-tp.herokuapp.com/borrarCampoVip';
  crearIndiceCampoNombre = 'https://backend-mongodb-tp.herokuapp.com/crearIndiceCampoNombre';
  indices = 'https://backend-mongodb-tp.herokuapp.com/indices';
  borrarIndice = 'https://backend-mongodb-tp.herokuapp.com/borrarIndice';
  crearIndiceTexto = 'https://backend-mongodb-tp.herokuapp.com/crearIndiceTexto';
  contienePalabraHd = 'https://backend-mongodb-tp.herokuapp.com/contienePalabraHd';
  clientesConCanalSpace = 'https://backend-mongodb-tp.herokuapp.com/clientesConCanalSpace';
  pendientesConVacaciones = 'https://backend-mongodb-tp.herokuapp.com/pendientesConVacaciones';
  queHay = 'https://backend-mongodb-tp.herokuapp.com/queHay';
  tienenAtributoCampoVip = 'https://backend-mongodb-tp.herokuapp.com/tienenAtributoCampoVip';
  tipoCanalesAgregados = 'https://backend-mongodb-tp.herokuapp.com/tipoCanalesAgregados';
  agregadosCanalesEspecificos = 'https://backend-mongodb-tp.herokuapp.com/agregadosCanalesEspecificos';
  paguenMenosOMasQueEstosValores = 'https://backend-mongodb-tp.herokuapp.com/paguenMenosOMasQueEstosValores';
  response = "";
  query = "";
